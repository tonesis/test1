...
cd /etc/nginx/conf.d/ && wget  https://raw.githubusercontent.com/tonesis/test1/main/config/monit.conf
cd /etc/monit/ && wget https://github.com/tonesis/test1/blob/main/config/monitrc
echo "restart vm"
shutdown -r now
